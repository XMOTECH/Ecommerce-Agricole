...
export function SignUp({ onNavigateToLogin, onSignUp }: SignUpProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1e4d3d] via-[#2a5f4a] to-[#1e4d3d] dark:from-[#0d1f19] dark:via-[#153a2d] dark:to-[#0d1f19] flex items-center justify-center p-4">
      {/* Theme Toggle */}
